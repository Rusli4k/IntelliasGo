...
func main() {
	...
	fmt.Printf("В нас 23 гривні, отже за них ми можемо купити %.f груші\n", wallet/pearcost)
	fmt.Println("______________")
	fmt.Println("Питання третє:")
	fmt.Println("Скільки яблук ми можемо купити?")
	fmt.Printf("В нас 23 гривні, отже за них ми можемо купити %.f яблука\n", wallet/applecost)
	fmt.Println("______________")
	...
	if wallet >= 2*applecost+2*pearcost {
		...
		fmt.Printf("Дві груші та 2 яблука, котують %.2f. А в нас 23 гривні, отже нам не вистачає грошей \n______________\n", 2*applecost+2*pearcost)
	}

	fmt.Println("Мені завжди було шкода вчителів, які мусили перевіряти зошити учнів після уроків )")
}
